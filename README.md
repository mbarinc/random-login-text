...
About
-----
The Python script read at random a row in a text file (di default è choise /opt/local/bbin) that contain my phrases database.
...
2. add a call to the script in  the "System Preferences" -> "Accounts" menù
